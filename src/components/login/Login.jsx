...
const Login = () => {
  return (
    <main className=" relative flex justify-center items-center h-screen bg-gray-100 bg-[url('assets/Login-bg.jpg')] bg-cover bg-center">
      <div className="bg-blue-950 text-3xl text-white font-sans  w-78 h-81 rounded-20 flex justify center items-center p-0 font-san rounded-bl-2xl rounded-tl-2xl">
      ...
      <section className="bg-white p-8 rounded-tr-2xl rounded-br-2xl shadow-md w-96">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <button className="bg-[#043873] text-white py-2  hover:bg-[#043873]/80 transition">Login Now</button>
        </div>
      </section>
    </main>
  )
