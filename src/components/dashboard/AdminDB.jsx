...
const SidebarItem = (
  { icon, text, active, href = "#", onClick } // Added onClick
) => (
  <a
    href={href}
...
const StatCard = (
  { title, value, className = "" } // Added className prop
) => (
  <div
...
const StatusBadge = ({ status }) => {
  ...
  return (
    <span
      className={`px-2 py-0.5 md:px-3 md:py-1 inline-flex text-xs leading-5 font-semibold rounded whitespace-nowrap ${
