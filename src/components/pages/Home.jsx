      ...
      <main className="bg-[#043873] text-white">
        ...
        >
          <div>
            ...
            <button className="border-2 border-blue-950 px-6 py-3 mt-5 hover:bg-blue-950 hover:text-white transition duration-300 transform hover:scale-105">
              GET STARTED
            </button>
          </div>

          <div className="flex justify-center" data-aos="fade-left">
            <img src={pic1} alt="Hero" className="w-full max-w-md lg:max-w-lg cursor-pointer" />
          </div>
        ...
        {/* Collaborate Section */}
        <section
          className="py-20 px-5 lg:px-20 bg-gray-100 text-black grid lg:grid-cols-2 gap-10"
          data-aos="fade-up"
        >
          ...
          <div className="flex justify-center order-1 lg:order-2" data-aos="fade-right">
        ...
        <section
          className="py-20 px-5 lg:px-20 bg-gray-100 text-black text-center"
          data-aos="fade-up"
        >
