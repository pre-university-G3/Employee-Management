  ...
  return (
    <>
      <main>
        ...
        {/* Main Grid Section */}
        <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-6 xl:grid-cols-6 grid-rows-auto gap-4 sm:gap-4 md:gap-6 lg:gap-8 xl:gap-8 p-4 sm:px-4 sm:py-2 md:px-6 md:py-4 lg:p-0 lg:pt-8 lg:pl-30 lg:pr-20 xl:p-0 xl:pt-8 xl:pl-30 xl:pr-20">
          {/* First Box */}
          <div className="bg-[#E1E5F2] col-span-1 sm:col-span-2 md:col-span-2 lg:col-span-2 row-span-3 h-auto sm:h-[280px] md:h-[300px] lg:h-[320px] xl:h-[300px] rounded-[20px] flex flex-col">
            <div className="w-full h-auto sm:h-[35%] md:h-[40%] lg:h-[40%]">
              <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-start ml-0 sm:ml-4 md:ml-5 lg:ml-6 mt-1 h-full">                    
                <span className="text-xl sm:text-2xl mr-0 sm:mr-5">
                  <img src={Sun} className="w-[60px] sm:w-[60px] md:w-[60px] lg:w-[40px] xl:w-[60px] h-[60px] sm:h-[60px] md:h-[60px] lg:h-[40px] xl:h-[60px]" alt="Sun Icon" />
                </span>
                <div className="flex flex-col items-center sm:items-start">
                  <h2 className="text-xl sm:text-xl md:text-2xl lg:text-[20px] xl:text-[20px] font-bold text-gray-600">
                    {time.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', second: '2-digit' })}
                  </h2>
                  <p className="text-gray-600 mt-1 text-[10px] sm:text-[12px] md:text-[12px] lg:text-[14px] xl:text-[14px]">
                    Realtime Insight
                  </p>
                </div>
              </div>
          ...
          <div className="bg-[#043873] text-white col-span-1 sm:col-span-2 md:col-span-4 row-span-2 rounded-[10px] h-[150px] sm:h-[180px] md:h-[180px] xl:h-[190px] flex items-center justify-center">
            <div className="grid grid-cols-4 sm:grid-cols-4 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 gap-4 sm:gap-3 md:gap-4 xl:gap-8 w-full h-full text-center">
              <div className="flex flex-col items-center justify-center">
                <h2 className="text-[16px] sm:text-[20px] md:text-[18px] lg:text-[16px] xl:text-[18px] font-bold mb-1 sm:mb-2 md:mb-3 xl:mb-1">This Day</h2>
                <p className="text-[30px] sm:text-[40px] md:text-[50px] lg:text-[48px] xl:text-[50px] font-bold">17</p>
                <p className="mt-1 sm:mt-1 md:mt-2 xl:mt-3 text-[14px] sm:text-[14px] md:text-[16px] lg:text-[16px] xl:text-[16px]">Present</p>
              </div>
              <div className="flex flex-col items-center justify-center">
                <h2 className="text-[16px] sm:text-[20px] md:text-[18px] lg:text-[16px] xl:text-[18px] font-bold mb-1 sm:mb-2 md:mb-3 xl:mb-1">This Month</h2>
                <p className="text-[30px] sm:text-[40px] md:text-[50px] lg:text-[48px] xl:text-[50px] font-bold">04</p>
                <p className="mt-1 sm:mt-1 md:mt-2 xl:mt-3 text-[14px] sm:text-[14px] md:text-[16px] lg:text-[16px] xl:text-[16px]">Late</p>
              </div>
              <div className="flex flex-col items-center justify-center">
                <h2 className="text-[16px] sm:text-[20px] md:text-[18px] lg:text-[16px] xl:text-[18px] font-bold mb-1 sm:mb-2 md:mb-3 xl:mb-1">This Year</h2>
                <p className="text-[30px] sm:text-[40px] md:text-[50px] lg:text-[48px] xl:text-[50px] font-bold">01</p>
                <p className="mt-1 sm:mt-1 md:mt-2 xl:mt-3 text-[14px] sm:text-[14px] md:text-[16px] lg:text-[16px] xl:text-[16px]">Absent</p>
              </div>
              <div className="flex flex-col items-center justify-center">
                <h2 className="text-[16px] sm:text-[20px] md:text-[18px] lg:text-[16px] xl:text-[18px] font-bold mb-1 sm:mb-2 md:mb-3 xl:mb-1">Tracking</h2>
                <p className="text-[30px] sm:text-[40px] md:text-[50px] lg:text-[48px] xl:text-[50px] font-bold">22</p>
                <p className="mt-1 sm:mt-1 md:mt-2 xl:mt-3 text-[14px] sm:text-[14px] md:text-[16px] lg:text-[16px] xl:text-[16px]">Total</p>
              </div>
            </div>
          </div>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-6 xl:grid-cols-6 gap-4 sm:gap-5 md:gap-6 lg:gap-8 xl:gap-8 p-4 sm:px-4 sm:py-2 md:px-6 md:py-4 lg:p-0 lg:pt-8 lg:pl-30 lg:pr-20 xl:p-0 xl:pt-8 xl:pl-30 xl:pr-20">
          {/* Box 6 */}
          <div className="bg-[#AAD1FF] rounded-[20px] flex flex-col h-[150px] sm:h-[160px] md:h-[200px] lg:h-[200px] xl:h-[200px] lg:col-span-2 xl:col-span-2">
            <div className="w-full h-[60%] flex">
              <div className="w-[70%] h-full text-[60px] sm:text-[50px] md:text-[80px] lg:text-[78px] xl:text-[80px] font-bold text-white text-center pl-10 sm:pl-4 md:pl-30 lg:pl-6 xl:pl-10">
                05
              </div>
            ...
            <div className="w-full h-[40%] flex items-center justify-center">
              <p className="text-[14px] sm:text-[16px] md:text-[20px] lg:text-[18px] xl:text-[20px] font-semibold text-center">
