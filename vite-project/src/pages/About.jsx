           ...
           {mentors.map((mentor, index) => (
             <div key={index} className="text-center">
               ...
               <div className="flex justify-center gap-4 mt-4">
                 <a href={mentor.github} className="text-3xl text-gray-800 hover:text-black">
                   <i className="fa-brands fa-github"></i>
                 </a>
                 <a href={`mailto:${mentor.email}`} className="text-3xl text-gray-800 hover:text-black">
         ...
         <figure className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 justify-center items-center px-5 mt-10">
           {teamMembers.map((member, index) => (
             <div key={index} className="text-center">
               ...
               <div className="flex justify-center gap-4 mt-4">
                 <a href={member.github} className="text-3xl text-gray-800 hover:text-black">
                   <i className="fa-brands fa-github"></i>
                 </a>
                 <a href={`mailto:${member.email}`} className="text-3xl text-gray-800 hover:text-black">
                   <i className="fa-solid fa-envelope"></i>
                 </a>
               </div>
             </div>
